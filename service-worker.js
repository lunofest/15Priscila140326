const CACHE_NAME = 'cache-v55'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v55',
    'estilos/styles.css?v55',
    'estilos/mediaQueries.css?v55',
    'javascript/script.js?v55',
