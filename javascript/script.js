...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543815411429'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543814016423'; // Número para el primer botón
  const recipientNumber2 = '543813449809'; // Número para el segundo botón
